...
export const getProductDetails = tool({
  description: `Get the details of a product by its ID. Use this when the user asks for the details of a product.`,
  inputSchema: z.object({
    productId: z
      .string()
      .describe("The ID of the product the user wants to get the details of."),
  }),
